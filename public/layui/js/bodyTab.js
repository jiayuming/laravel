...
layui.define(["element","jquery"],function(exports){
	...
	Tab.prototype.tabAdd = function(_this){
		...
		// $(".layui-nav .layui-nav-item a").on("click",function(){
			if(_this.find("i.iconfont,i.layui-icon,i.fa").attr("data-icon") != undefined){
				var title = '';
				if(that.hasTab(_this.find("cite").text()) == -1 && _this.siblings("dl.layui-nav-child").length == 0){
					...
					}else if(_this.find("i.iconfont").attr("data-icon") != undefined){
					...
					//当前窗口内容
                    if(_this.find("i.fa").attr("data-icon")){
                        var data_icon=_this.find("i.fa").attr("data-icon");
					}else if(_this.find("i.iconfont").attr("data-icon")){
                        var data_icon=_this.find("i.iconfont").attr("data-icon");
                    }else{
						var data_icon=_this.find("i.layui-icon").attr("data-icon");
					}
					var curmenu = {
						"icon" : data_icon,
